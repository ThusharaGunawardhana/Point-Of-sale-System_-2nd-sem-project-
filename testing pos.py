...
class Bill_App:
    def __init__(self, root):
        ...
        # Add your GUI content to the frame
        self.add_gui_content()


    def add_gui_content(self):
        # Your GUI content here
        Ibl_title = tk.Label(self.main_frame, text="HERATH TILES & ACCESSORIES", font=("times new roman", 28), bg="black", fg="white")
        Ibl_title.pack(fill="x")

        # Create Cust_Frame as a LabelFrame inside self.main_frame
        Cust_Frame = tk.LabelFrame(self.main_frame, text="Customer", bg="white", fg="red")
        Cust_Frame.pack(padx=10, pady=5, fill="both")

        # Use self.c_name and self.c_phone to access these variables in the entire class.
        ...
        Main_Frame.place(x=0, y=170, width=1530, height=620)
        ...
        self.Btnser = Button(search_Frame,   cursor="hand2", text="serach", font=('arial', 15, 'bold'), bg="red", fg="white")
        ...
        self.BtnAddToCartImage1 = PhotoImage(file="C:\\Users\\Thushara\\Desktop\\2nd sem project\\pos buttons\\addtocart.png")
        self.BtnAddToCart = Button(Btn_Frame, image=self.BtnAddToCartImage1, command=self.AddItem, cursor="hand2", bg="white", bd=0)
        self.BtnAddToCart.grid(row=0, column=0)

        self.BtnAddToCartImage2 = PhotoImage(file="C:\\Users\\Thushara\\Desktop\\2nd sem project\\pos buttons\\generatebill.png")
        ...
        self.BtnAddToCartImage4 = PhotoImage(file="C:\\Users\\Thushara\\Desktop\\2nd sem project\\pos buttons\\print.png")
        self.Btnprint = Button(Btn_Frame,image=self.BtnAddToCartImage4, cursor="hand2", bg="white", bd=0)
        self.Btnprint.grid(row=0, column=3)

        self.BtnAddToCartImage5 = PhotoImage(file="C:\\Users\\Thushara\\Desktop\\2nd sem project\\pos buttons\\clear.png")
        self.Btnclear = Button(Btn_Frame,image=self.BtnAddToCartImage5, cursor="hand2", bg="white", bd=0)
        self.Btnclear.grid(row=0, column=4)

        self.BtnAddToCartImage6 = PhotoImage(file="C:\\Users\\Thushara\\Desktop\\2nd sem project\\pos buttons\\exit.png")        
        self.Btnexit = Button(Btn_Frame,image=self.BtnAddToCartImage6, cursor="hand2", bg="white", bd=0)
    ...
    def save_bill(self):
        ...
        if op>0:
            self.bill_data=self.textarea.get(0.1,END)
    ...
    def welcome(self):
        ...
        self.textarea.insert(END,"\t Wellcome Herath tiles & Accessories")
